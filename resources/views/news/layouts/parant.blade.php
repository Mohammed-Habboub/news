                            ...
                            <div class="main-menu d-none d-md-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="{{route('news.about')}}">about</a></li>
                                        <li><a href="{{route('news.categori')}}">Category</a></li>
                                        <li><a href="{{route('news.latest')}}">Latest News</a></li>
                                        <li><a href="#">Pages</a>
                                            <ul class="submenu">
                                                <li><a href="{{route('news.blog')}}">Blog</a></li>
                                                <li><a href="{{route('news.blog_details')}}">Blog Details</a></li>
                                                <li><a href="{{route('news.elements')}}">Element</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{route('news.contact')}}">Contact</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
