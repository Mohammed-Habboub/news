...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Mohammed Habboub</a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <b><li class="nav-header">- Content Management</li></b>
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-solid fa-briefcase"></i>
                                <p> categories <i class="fas fa-angle-left right"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <p> News <i class="fas fa-angle-left right"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <p> Comments <i class="fas fa-angle-left right"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
        ...
        <div class="content-wrapper">
            ...
            <!-- Main content --> @yield('content') {{-- <section class="content">
                <!-- Default box -->
                <div class="card">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2022-2023 <a href="#">{{env('APP_NAME')}}</a>.</strong> All rights
            reserved.
        </footer>
        <!-- Control Sidebar -->
